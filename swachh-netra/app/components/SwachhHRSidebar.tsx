...
interface SwachhHRSidebarProps {
  navigation: any
  isVisible: boolean
  onClose: () => void
...
const SwachhHRSidebar: React.FC<SwachhHRSidebarProps> = ({
  navigation,
  isVisible,
  onClose,
  onSelectAction,
  ...
  const sections: MenuSection[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          actionKey: "HRAttendanceDashboard",
  ...
  return (
    <>
      ...
      <Animated.View style={[styles.sidebar, { transform: [{ translateX: slideAnim }] }]}>
        <View style={styles.header}>
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerText}>
              <Text style={styles.headerTitle}>HR Panel</Text>
        ...
        <ScrollView style={styles.menuContainer} contentContainerStyle={styles.menuContentContainer} showsVerticalScrollIndicator={false} bounces={false}>
          {sections.map((section) => (
            <View key={section.id} style={styles.menuSection}>
              ...
              {section.items.map((item) => (
                <TouchableOpacity key={item.id} style={styles.menuItem} onPress={() => handlePress(item.actionKey)} activeOpacity={0.7}>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerSubtext}>HR Dashboard</Text>
        </View>
      </Animated.View>
    </>
  )
...
const styles = StyleSheet.create({
  ...
  badge: { backgroundColor: "#eff6ff", borderRadius: 12, width: 48, height: 48, justifyContent: "center", alignItems: "center", marginRight: 12 },
  headerText: { flex: 1 },
  ...
  sectionHeader: { flexDirection: "row", alignItems: "center", paddingHorizontal: 20, paddingVertical: 12, marginBottom: 4 },
  menuSectionTitle: { fontSize: 12, fontWeight: "700", color: "#6b7280", letterSpacing: 0.8, marginLeft: 8 },
  menuItem: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: 12, paddingHorizontal: 20, marginHorizontal: 12, borderRadius: 8 },
...
export default SwachhHRSidebar
